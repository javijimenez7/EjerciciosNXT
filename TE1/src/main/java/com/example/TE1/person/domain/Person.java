package com.example.TE1.person.domain;


import com.example.TE1.StringPrefixedSequenceIdGenerator;
...
public class Person {
    ...
    @GenericGenerator(
            name = "seq",
            strategy = "com.example.TE1.StringPrefixedSequenceIdGenerator",
            parameters = {
